...
class Gui:
    ...
    def __init__(
        ...
        self._set_css_file(self.__frame, css_file)
    ...
    def _set_css_file(self, frame: FrameType, css_file: t.Optional[str] = None):
        if css_file is None:
            script_file = pathlib.Path(frame.f_code.co_filename or ".").resolve()
