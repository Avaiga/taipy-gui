...
def ws_u_assert_template(gui: Gui, helpers, value_before_update, value_after_update, payload):
    ...
    ws_client.emit(
        "message", {"client_id": sid, "type": "U", "name": "tpec_TaIpY_EXPR_var_TPMDL_0", "payload": payload}
    )
    ...
    helpers.assert_outward_ws_message(received_message[0], "MU", "tpec_TaIpY_EXPR_var_TPMDL_0", value_after_update)
