...
def test_tree_md(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'defaultValue="[&quot;Item 1&quot;]"',
        'updateVarName="_TpLv_tpec_TaIpY_EXPR_value_TPMDL_0"',
        "value={_TpLv_tpec_TaIpY_EXPR_value_TPMDL_0}",
    ]
...
def test_tree_expanded_md_2(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        "expanded={tpec_TaIpY_EXPR_expa_TPMDL_0}",
        'updateVars="expanded=tpec_TaIpY_EXPR_expa_TPMDL_0',
    ]
    helpers.test_control_md(gui, md_string, expected_list)
