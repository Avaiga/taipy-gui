...
def test_selector_md_1(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        "filter={true}",
        "multiple={true}",
        'updateVarName="_TpLv_tpec_TaIpY_EXPR_selected_val_TPMDL_0"',
        "value={_TpLv_tpec_TaIpY_EXPR_selected_val_TPMDL_0}",
    ]
...
def test_selector_md_3(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'defaultValue="[&quot;1&quot;]"',
        "lov={_TpL_tpec_TaIpY_EXPR_scenario_list_TPMDL_0}",
        "propagate={false}",
        'updateVars="lov=_TpL_tpec_TaIpY_EXPR_scenario_list_TPMDL_0"',
        'updateVarName="_TpLv_tpec_TaIpY_EXPR_selected_obj_TPMDL_0"',
        "value={_TpLv_tpec_TaIpY_EXPR_selected_obj_TPMDL_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
