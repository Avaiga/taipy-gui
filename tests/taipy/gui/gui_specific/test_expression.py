...
def test_expression_text_control_str(gui: Gui, test_client, helpers):
    ...
    md_string = "<|{x}|>"
    expected_list = ["<Field", 'dataType="str"', 'defaultValue="Hello World!"', "value={tpec_TaIpY_EXPR_x_TPMDL_0}"]
...
def test_expression_text_control_int(gui: Gui, test_client, helpers):
    ...
    md_string = "<|{x}|>"
    expected_list = ["<Field", 'dataType="int"', 'defaultValue="10"', "value={tpec_TaIpY_EXPR_x_TPMDL_0}"]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_text_control_1(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'dataType="int"',
        'defaultValue="30"',
        "value={tp_TaIpY_EXPR_x_y_TPMDL_0_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_text_control_2(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'dataType="str"',
        'defaultValue="x + y = 30"',
        "value={tp_TaIpY_EXPR_x_y_x_y_TPMDL_0_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_text_control_3(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        "value={tp_TaIpY_EXPR_Hello_x_and_y_TPMDL_0_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_text_gt_operator(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'dataType="bool"',
        'defaultValue="false"',
        "value={tp_TaIpY_EXPR_x_0_TPMDL_0_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_button_control(gui: Gui, test_client, helpers):
    ...
    expected_list = ["<Button", 'defaultLabel="A button label"', "label={tpec_TaIpY_EXPR_label_TPMDL_0}"]
    helpers.test_control_md(gui, md_string, expected_list)
...
def test_expression_table_control(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'updateVarName="_TpD_tp_TaIpY_EXPR_pd_concat_series_1_series_2_axis_1_TPMDL_0_0"',
        "data={_TpD_tp_TaIpY_EXPR_pd_concat_series_1_series_2_axis_1_TPMDL_0_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
    assert isinstance(gui._get_data_scope().tp_TaIpY_EXPR_pd_concat_series_1_series_2_axis_1_TPMDL_0_0, pd.DataFrame)
...
def test_lambda_expression_selector(gui: Gui, test_client, helpers):
    ...
    expected_list = [
        ...
        'defaultValue="[&quot;1&quot;]"',
        'updateVars="lov=_TpL_tpec_TaIpY_EXPR_lov_TPMDL_0"',
        "lov={_TpL_tpec_TaIpY_EXPR_lov_TPMDL_0}",
        'updateVarName="_TpLv_tpec_TaIpY_EXPR_sel_TPMDL_0"',
        "value={_TpLv_tpec_TaIpY_EXPR_sel_TPMDL_0}",
    ]
    helpers.test_control_md(gui, md_string, expected_list)
